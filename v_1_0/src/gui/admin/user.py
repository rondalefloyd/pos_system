...
class MyUserView(MyWidget):
    ...
    def set_view_dialog(self):
        ...
        self.info_layout.addRow('Password:', self.user_password_info)
        self.info_layout.addRow('Access level:', self.user_level_info)
        self.info_layout.addRow('Phone:', self.user_phone_info)
