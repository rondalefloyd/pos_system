...
from item_management import ItemManagementWindow
...
class AdminMain(QWidget):
    ...
    def createMainLayout(self):
        ...
        nav_bar_layout = self.onNavBarWidget()
        content_layout = self.onContentWidget()
