...
class MyTableWidget(QTableWidget):
    ...
    def on_panel_a_widgets(self, object_name):
        if object_name == 'user_list_table':
            self.setColumnCount(6)
            self.setHorizontalHeaderLabels(['Action','Name','Password','Access level','Phone','Date created'])
...
class MyHBoxLayout(QHBoxLayout):
    def __init__(self, object_name=''):
        ...
        self.on_edit_user_dialog(object_name)
        self.on_show_user_dialog(object_name)

    def on_panel_a_widgets(self, object_name):
        if object_name == 'text_filter_layout':
            self.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
            pass
        if object_name == 'add_user_layout':
            self.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
            pass
        if object_name == 'add_user_form_act_layout':
            self.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        if object_name == 'user_list_pag_act_layout':
    ...
    def on_list_act_box(self, object_name):
        ...
        pass
    def on_edit_user_dialog(self, object_name):
        if object_name == 'edit_user_form_act_layout':
            self.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        pass
    def on_show_user_dialog(self, object_name):
        if object_name == 'show_user_act_layout':
            self.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        pass
    pass
...
class MyComboBox(QComboBox):
    def __init__(self, object_name=''):
        ...
        self.on_user_form_box_widgets(object_name)

    def on_user_form_box_widgets(self, object_name):
        if object_name == 'user_type_field':
