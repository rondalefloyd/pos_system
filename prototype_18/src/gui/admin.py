...
class AdminWindow(MyWidget):
    ...
    def default_values(self):
        if self.stacked_content_panel.currentIndex() == 0:
            self.promo_content_button.setStyleSheet('QPushButton { background-color: #303338; border: 0px; border-radius: 5px; text-align: left; color: #fff; padding: 10px }')
    ...
    def on_settings_content_button_clicked(self):
        # self.stacked_content_panel.setCurrentIndex(4)
        pass
