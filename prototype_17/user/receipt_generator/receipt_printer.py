...
class ReceiptGenerator():
    ...
    def __init__(self, filename=''):
        ...
        docx_file = os.path.abspath(os.path.join(os.path.dirname(__file__), '../receipt_generator/raw_receipt.docx'))
        ...
        doc.SaveAs(os.path.abspath(os.path.join(os.path.dirname(__file__), '../receipt_generator/updated_receipt.docx')))  # Save with the same file path to overwrite the original

        # Specify the path to the DOCX file
        updated_docx_file = os.path.abspath(os.path.join(os.path.dirname(__file__), '../receipt_generator/updated_receipt.docx'))
